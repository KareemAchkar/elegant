...
import { ShopProductsType, CarouselProductsType, storeOffersType } from '../types/carouselProducts';
...
type ProductsTypeContext = {
  ...
  addedProducts: ShopProductsType[];
  setAddedProducts: React.Dispatch<SetStateAction<ShopProductsType[]>>;
  storedAddeditems: [];
};
...
export const ProductsProvider: React.FC<Props> = ({ children }) => {
  ...
  const [addedProducts, setAddedProducts] = useState<ShopProductsType[]>([]);
